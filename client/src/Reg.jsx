...
const Reg = () => {
    ...
    const handleSubmit = (e) =>{
        e.preventDefault()
        console.log(email)
        axios.post(`${import.meta.env.VITE_KEY}register`,{username,email,password})
        .then((res)=>{
            console.log("Success")
            if(res.data==="ok"){
                alert("User Created")
  ...
  return (
    <div>
      ...
      <form action='#' method="post" onSubmit={handleSubmit} >
        ...
        <input type="email"  name="email" placeholder="user@gmail.com" onChange={(e)=>setEmail(e.target.value)} /><br/>
        <input type="password" name="pwd"  placeholder="Password" onChange={(e)=>setPassword(e.target.value)} /><br/>
